...
def calc_movements(data, loc0, balloon, live_data=None, alt_change_fit=10, descent_only=False):
    ...
    if not descent_only:
        ...
        data = pyb_aux.data_interpolation(data, alt0, balloon['altitude_step'], mode='spline')
        ...
        max_altitudes, lat_max_altitudes, lon_max_altitudes = alt0, lat0, lon0
